...
router.delete("/minimi/:id",   auth.super_read_auth, admin.minimi_delete); // 미니미 삭제
router.delete("/miniroom/:id", auth.super_read_auth, admin.miniroom_delete); // 미니룸 삭제

router.get('/minimi',          admin.minimi_list); // 미니미 등록 리스트
router.get('/miniroom',        admin.miniroom_list); // 미니룸 등록 리스트
